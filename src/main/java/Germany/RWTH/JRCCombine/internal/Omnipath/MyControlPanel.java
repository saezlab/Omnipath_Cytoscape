...
//		
//		URL url = new URL("http://omnipathdb.org/databases/interactions/?format=json");
//		 try (InputStream is = url.openStream();
//		       JsonReader rdr = Json.createReader(is)) {
//		       JsonObject obj = rdr.readObject();
//		      
//		      System.out.println("Emp Name: " + obj.getJsonArray("PPI"));
//		      System.out.println("Emp Name: " + obj.getJsonArray("TF"));
//		      System.out.println("Emp Name: " + obj.getJsonArray("MTI"));
//		 }
